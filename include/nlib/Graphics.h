...
// (a different header sharing the basename) when Pcam/Camera.h is on the stack -- it
...
// TODO: We should probably just rename "include/Pcam/Camera.h" because this is weird.
#include <Camera.h>
