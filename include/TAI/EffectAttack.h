...
public:
	...
	void init(TAIeffectAttackParam* attackParam, Teki* teki, immut Vector3f& startPos, Vector3f velocity, f32 duration, f32 damage,
	          f32 maxRange, f32 radius, TAIeffectAttackEventCallBack* eventCB);
