...
/* 8014D2F0 0014A250  41 82 00 54 */	beq .L_8014D344
...
/* 8014D40C 0014A36C  40 82 00 20 */	bne .L_8014D42C
...
/* 8014D428 0014A388  48 00 00 90 */	b .L_8014D4B8
.L_8014D42C:
/* 8014D42C 0014A38C  28 03 00 02 */	cmplwi r3, 2
/* 8014D430 0014A390  40 80 00 7C */	bge .L_8014D4AC
...
/* 8014D4A8 0014A408  48 00 00 10 */	b .L_8014D4B8
.L_8014D4AC:
...
/* 8014D654 0014A5B4  40 82 00 18 */	bne .L_8014D66C
...
/* 8014D668 0014A5C8  48 00 01 18 */	b .L_8014D780
.L_8014D66C:
/* 8014D66C 0014A5CC  2C 00 00 01 */	cmpwi r0, 1
/* 8014D670 0014A5D0  40 82 00 18 */	bne .L_8014D688
...
/* 8014D684 0014A5E4  48 00 00 FC */	b .L_8014D780
.L_8014D688:
/* 8014D688 0014A5E8  2C 00 00 02 */	cmpwi r0, 2
/* 8014D68C 0014A5EC  40 82 00 38 */	bne .L_8014D6C4
...
/* 8014D6C0 0014A620  48 00 00 C0 */	b .L_8014D780
.L_8014D6C4:
/* 8014D6C4 0014A624  2C 00 00 03 */	cmpwi r0, 3
/* 8014D6C8 0014A628  40 82 00 18 */	bne .L_8014D6E0
...
/* 8014D6DC 0014A63C  48 00 00 A4 */	b .L_8014D780
.L_8014D6E0:
/* 8014D6E0 0014A640  2C 00 00 04 */	cmpwi r0, 4
/* 8014D6E4 0014A644  40 82 00 14 */	bne .L_8014D6F8
...
/* 8014D6F4 0014A654  48 00 00 8C */	b .L_8014D780
.L_8014D6F8:
/* 8014D6F8 0014A658  2C 00 00 05 */	cmpwi r0, 5
/* 8014D6FC 0014A65C  40 82 00 18 */	bne .L_8014D714
...
/* 8014D710 0014A670  48 00 00 70 */	b .L_8014D780
.L_8014D714:
/* 8014D714 0014A674  2C 00 00 06 */	cmpwi r0, 6
/* 8014D718 0014A678  40 82 00 18 */	bne .L_8014D730
...
/* 8014D72C 0014A68C  48 00 00 54 */	b .L_8014D780
.L_8014D730:
/* 8014D730 0014A690  2C 00 00 07 */	cmpwi r0, 7
/* 8014D734 0014A694  40 82 00 18 */	bne .L_8014D74C
...
/* 8014D748 0014A6A8  48 00 00 38 */	b .L_8014D780
.L_8014D74C:
/* 8014D74C 0014A6AC  2C 00 00 08 */	cmpwi r0, 8
/* 8014D750 0014A6B0  40 82 00 18 */	bne .L_8014D768
...
/* 8014D764 0014A6C4  48 00 00 1C */	b .L_8014D780
.L_8014D768:
/* 8014D768 0014A6C8  2C 00 00 09 */	cmpwi r0, 9
/* 8014D76C 0014A6CC  40 82 00 14 */	bne .L_8014D780
...
/* 8014D7AC 0014A70C  40 82 00 18 */	bne .L_8014D7C4
...
/* 8014D7C0 0014A720  48 00 00 FC */	b .L_8014D8BC
.L_8014D7C4:
/* 8014D7C4 0014A724  2C 00 00 01 */	cmpwi r0, 1
/* 8014D7C8 0014A728  40 82 00 18 */	bne .L_8014D7E0
...
/* 8014D7DC 0014A73C  48 00 00 E0 */	b .L_8014D8BC
.L_8014D7E0:
/* 8014D7E0 0014A740  2C 00 00 02 */	cmpwi r0, 2
/* 8014D7E4 0014A744  40 82 00 18 */	bne .L_8014D7FC
...
/* 8014D7F8 0014A758  48 00 00 C4 */	b .L_8014D8BC
.L_8014D7FC:
/* 8014D7FC 0014A75C  2C 00 00 03 */	cmpwi r0, 3
/* 8014D800 0014A760  40 82 00 18 */	bne .L_8014D818
...
/* 8014D814 0014A774  48 00 00 A8 */	b .L_8014D8BC
.L_8014D818:
/* 8014D818 0014A778  2C 00 00 04 */	cmpwi r0, 4
/* 8014D81C 0014A77C  40 82 00 18 */	bne .L_8014D834
...
/* 8014D830 0014A790  48 00 00 8C */	b .L_8014D8BC
.L_8014D834:
/* 8014D834 0014A794  2C 00 00 05 */	cmpwi r0, 5
/* 8014D838 0014A798  40 82 00 18 */	bne .L_8014D850
...
/* 8014D84C 0014A7AC  48 00 00 70 */	b .L_8014D8BC
.L_8014D850:
/* 8014D850 0014A7B0  2C 00 00 06 */	cmpwi r0, 6
/* 8014D854 0014A7B4  40 82 00 18 */	bne .L_8014D86C
...
/* 8014D868 0014A7C8  48 00 00 54 */	b .L_8014D8BC
.L_8014D86C:
/* 8014D86C 0014A7CC  2C 00 00 07 */	cmpwi r0, 7
/* 8014D870 0014A7D0  40 82 00 18 */	bne .L_8014D888
...
/* 8014D884 0014A7E4  48 00 00 38 */	b .L_8014D8BC
.L_8014D888:
/* 8014D888 0014A7E8  2C 00 00 08 */	cmpwi r0, 8
/* 8014D88C 0014A7EC  40 82 00 18 */	bne .L_8014D8A4
...
/* 8014D8A0 0014A800  48 00 00 1C */	b .L_8014D8BC
.L_8014D8A4:
/* 8014D8A4 0014A804  2C 00 00 09 */	cmpwi r0, 9
/* 8014D8A8 0014A808  40 82 00 14 */	bne .L_8014D8BC
