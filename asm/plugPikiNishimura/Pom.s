...
.endfn __ct__7PomPropFv

.fn __ct__3PomFP12CreatureProp, global
...
/* 801780E0 00175040  41 82 00 0C */	beq .L_801780EC
...
/* 80178100 00175060  41 82 00 0C */	beq .L_8017810C
...
.endfn __ct__3PomFP12CreatureProp

.fn getiMass__3PomFv, global
/* 8017812C 0017508C  C0 22 AD CC */	lfs f1, lbl_803EAFCC@sda21(r2)
/* 80178130 00175090  4E 80 00 20 */	blr 
.endfn getiMass__3PomFv

.fn init__3PomFR8Vector3f, global
...
.endfn init__3PomFR8Vector3f

.fn setColor__3PomFi, global
...
/* 801781A4 00175104  41 80 00 0C */	blt .L_801781B0
/* 801781A8 00175108  2C 00 00 02 */	cmpwi r0, 2
/* 801781AC 0017510C  40 81 00 4C */	ble .L_801781F8
.L_801781B0:
...
.endfn setColor__3PomFi

.fn doKill__3PomFv, global
...
.endfn doKill__3PomFv

.fn exitCourse__3PomFv, global
...
.endfn exitCourse__3PomFv

.fn update__3PomFv, global
...
.endfn update__3PomFv

.fn refresh__3PomFR8Graphics, global
...
/* 80178310 00175270  41 82 00 98 */	beq .L_801783A8
...
.endfn refresh__3PomFR8Graphics

.fn drawShape__3PomFR8Graphics, global
...
/* 801783F0 00175350  41 82 00 3C */	beq .L_8017842C
...
.endfn drawShape__3PomFR8Graphics

.fn doAI__3PomFv, global
...
/* 80178480 001753E0  41 82 00 1C */	beq .L_8017849C
...
.endfn doAnimation__3PomFv

.fn collisionCallback__3PomFR9CollEvent, global
...
/* 801784C4 00175424  41 82 00 0C */	beq .L_801784D0
/* 801784C8 00175428  2C 00 00 36 */	cmpwi r0, 0x36
/* 801784CC 0017542C  40 82 00 24 */	bne .L_801784F0
.L_801784D0:
/* 801784D0 00175430  88 03 03 B8 */	lbz r0, 0x3b8(r3)
/* 801784D4 00175434  28 00 00 00 */	cmplwi r0, 0
/* 801784D8 00175438  40 82 00 0C */	bne .L_801784E4
...
.endfn collisionCallback__3PomFR9CollEvent

.fn read__7PomPropFR18RandomAccessStream, weak
...
.endfn read__7PomPropFR18RandomAccessStream

.fn "@492@read__7PomPropFR18RandomAccessStream", weak
/* 80178550 001754B0  38 63 FE 14 */	addi r3, r3, -492
/* 80178554 001754B4  4B FF FF AC */	b read__7PomPropFR18RandomAccessStream
.endfn "@492@read__7PomPropFR18RandomAccessStream"

.section .data, "wa"  # 0x80222DC0 - 0x802E9640
.balign 8
.obj lbl_802D0A78, local
	.asciz "CoreNode"
.endobj lbl_802D0A78
.balign 4
.obj lbl_802D0A84, local
	.asciz "EventTalker"
.endobj lbl_802D0A84
.balign 4
.obj lbl_802D0A90, local
	.asciz "RefCountable"
.endobj lbl_802D0A90
.balign 4
.obj lbl_802D0AA0, local
	.asciz "Creature"
.endobj lbl_802D0AA0
.balign 4
.obj lbl_802D0AAC, local
...
.endobj __vt__3Pom
.balign 4
.obj lbl_802D0C24, local
	.asciz "Parm<int>"
.endobj lbl_802D0C24
.balign 4
.obj lbl_802D0C30, local
	.asciz "BaseParm"
.endobj lbl_802D0C30
.balign 4
.obj lbl_802D0C3C, local
...
.balign 4
.obj lbl_802D0C5C, local
	.asciz "Parm<float>"
.endobj lbl_802D0C5C
.balign 4
.obj lbl_802D0C68, local
	.4byte __RTTI__8BaseParm
	.4byte 0
	.4byte 0
.endobj lbl_802D0C68
...
.skip 0x14 # compiler padding
.balign 4
.obj lbl_802D0C88, local
	.4byte __RTTI__5ANode
	.4byte 0
	.4byte 0
.endobj lbl_802D0C88
.balign 4
.obj lbl_802D0C94, local
	.asciz "CreatureProp"
.endobj lbl_802D0C94
.balign 4
.obj lbl_802D0CA4, local
	.asciz "BossProp"
.endobj lbl_802D0CA4
.balign 4
.obj lbl_802D0CB0, local
	.4byte __RTTI__12CreatureProp
	.4byte 0
	.4byte 0
.endobj lbl_802D0CB0
.balign 4
.obj lbl_802D0CBC, local
	.4byte __RTTI__5ANode
	.4byte 0x1ec
...
.endobj __vt__7PomProp
.balign 4
.skip 0x1C # compiler padding

.section .sdata, "wa"  # 0x803DCD20 - 0x803E7820
.balign 8
.obj lbl_803E52C8, local
	.asciz "Pom"
.endobj lbl_803E52C8
.balign 4
.obj lbl_803E52CC, local
	.asciz "s00"
.endobj lbl_803E52CC
.balign 4
.obj lbl_803E52D0, local
	.asciz "s01"
.endobj lbl_803E52D0
.balign 4
.obj lbl_803E52D4, local
	.asciz "s02"
.endobj lbl_803E52D4
.balign 4
.obj lbl_803E52D8, local
	.asciz "p00"
.endobj lbl_803E52D8
.balign 4
.obj lbl_803E52DC, local
	.asciz "p10"
.endobj lbl_803E52DC
.balign 4
.obj lbl_803E52E0, local
	.asciz "i00"
.endobj lbl_803E52E0
.balign 4
.obj lbl_803E52E4, local
	.asciz "i10"
.endobj lbl_803E52E4
.balign 4
.obj lbl_803E52E8, local
	.asciz "i11"
.endobj lbl_803E52E8
.balign 4
.obj lbl_803E52EC, local
	.asciz "i20"
.endobj lbl_803E52EC
.balign 4
.obj lbl_803E52F0, local
	.asciz "i90"
.endobj lbl_803E52F0
.balign 4
.obj lbl_803E52F4, local
	.asciz "i91"
.endobj lbl_803E52F4
.balign 4
.obj lbl_803E52F8, local
	.asciz "i92"
.endobj lbl_803E52F8
.balign 4
...
.balign 4
.obj lbl_803E5334, local
	.asciz "PomProp"
.endobj lbl_803E5334
.balign 4
.obj lbl_803E533C, local
	.asciz "ANode"
.endobj lbl_803E533C
.balign 4
...
.balign 4
.obj __RTTI__7PomProp, local
	.4byte lbl_803E5334
	.4byte lbl_802D0CBC
.endobj __RTTI__7PomProp

.section .sdata2, "a"  # 0x803E8200 - 0x803EC840
.balign 8
.obj lbl_803EAFB0, local
	.float 0.2
.endobj lbl_803EAFB0
.obj lbl_803EAFB4, local
	.float 0.5
.endobj lbl_803EAFB4
.obj lbl_803EAFB8, local
	.float 0.15
.endobj lbl_803EAFB8
.obj lbl_803EAFBC, local
	.float 10.0
.endobj lbl_803EAFBC
.obj lbl_803EAFC0, local
	.float 180.0
.endobj lbl_803EAFC0
.obj lbl_803EAFC4, local
	.float 1.0
.endobj lbl_803EAFC4
.obj lbl_803EAFC8, local
	.float 0.0
.endobj lbl_803EAFC8
.obj lbl_803EAFCC, local
	.float 0.0001
.endobj lbl_803EAFCC
.obj lbl_803EAFD0, local
	.float 20.0
.endobj lbl_803EAFD0
.obj lbl_803EAFD4, local
	.float 50.0
.endobj lbl_803EAFD4
.obj lbl_803EAFD8, local
	.float 32767.0
.endobj lbl_803EAFD8
.obj lbl_803EAFDC, local
	.float 2.999997
.endobj lbl_803EAFDC
.balign 8
.obj lbl_803EAFE0, local
