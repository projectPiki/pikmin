...
/* 801A1E4C 0019EDAC  40 81 00 48 */	ble .L_801A1E94
/* 801A1E50 0019EDB0  28 04 00 08 */	cmplwi r4, 8
/* 801A1E54 0019EDB4  38 C4 FF F8 */	addi r6, r4, -8
/* 801A1E58 0019EDB8  40 81 00 24 */	ble .L_801A1E7C
...
/* 801A1E6C 0019EDCC  40 81 00 10 */	ble .L_801A1E7C
.L_801A1E70:
/* 801A1E70 0019EDD0  38 E7 00 20 */	addi r7, r7, 0x20
/* 801A1E74 0019EDD4  38 A5 00 08 */	addi r5, r5, 8
/* 801A1E78 0019EDD8  42 00 FF F8 */	bdnz .L_801A1E70
.L_801A1E7C:
...
/* 801A1E88 0019EDE8  40 80 00 0C */	bge .L_801A1E94
.L_801A1E8C:
/* 801A1E8C 0019EDEC  38 E7 00 04 */	addi r7, r7, 4
/* 801A1E90 0019EDF0  42 00 FF FC */	bdnz .L_801A1E8C
.L_801A1E94:
...
/* 801A1F24 0019EE84  40 81 00 08 */	ble .L_801A1F2C
...
/* 801A219C 0019F0FC  40 82 00 44 */	bne .L_801A21E0
...
/* 801A21C0 0019F120  41 80 00 20 */	blt .L_801A21E0
/* 801A21C4 0019F124  88 05 00 02 */	lbz r0, 2(r5)
/* 801A21C8 0019F128  28 00 00 00 */	cmplwi r0, 0
/* 801A21CC 0019F12C  41 82 00 0C */	beq .L_801A21D8
/* 801A21D0 0019F130  98 83 00 04 */	stb r4, 4(r3)
/* 801A21D4 0019F134  48 00 00 0C */	b .L_801A21E0
.L_801A21D8:
...
/* 801A2218 0019F178  40 82 00 4C */	bne .L_801A2264
...
/* 801A2228 0019F188  41 82 00 2C */	beq .L_801A2254
...
/* 801A2250 0019F1B0  48 00 00 14 */	b .L_801A2264
.L_801A2254:
