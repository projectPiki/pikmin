...
.fn actByEvent__22TAIAhitCheckFlyingPikiFR9TekiEvent, global
...
/* 801A84A4 001A5404  40 82 00 28 */	bne .L_801A84CC
...
/* 801A84B4 001A5414  40 82 00 18 */	bne .L_801A84CC
/* 801A84B8 001A5418  4B F2 00 9D */	bl getState__4PikiFv
/* 801A84BC 001A541C  2C 03 00 0E */	cmpwi r3, 0xe
/* 801A84C0 001A5420  40 82 00 0C */	bne .L_801A84CC
/* 801A84C4 001A5424  38 60 00 01 */	li r3, 1
/* 801A84C8 001A5428  48 00 00 08 */	b .L_801A84D0
.L_801A84CC:
...
.endfn actByEvent__22TAIAhitCheckFlyingPikiFR9TekiEvent

.fn act__13TAIAdeadCheckFR4Teki, global
...
.endfn act__13TAIAdeadCheckFR4Teki

.fn start__7TAIAdieFR4Teki, global
...
.endfn start__7TAIAdieFR4Teki

.fn start__9TAIAdyingFR4Teki, global
...
/* 801A856C 001A54CC  41 82 00 38 */	beq .L_801A85A4
/* 801A8570 001A54D0  40 80 00 70 */	bge .L_801A85E0
/* 801A8574 001A54D4  2C 00 00 10 */	cmpwi r0, 0x10
/* 801A8578 001A54D8  41 82 00 08 */	beq .L_801A8580
/* 801A857C 001A54DC  48 00 00 64 */	b .L_801A85E0
.L_801A8580:
...
/* 801A85A0 001A5500  48 00 00 68 */	b .L_801A8608
.L_801A85A4:
...
/* 801A85DC 001A553C  48 00 00 2C */	b .L_801A8608
.L_801A85E0:
...
.endfn start__9TAIAdyingFR4Teki

.fn act__9TAIAdyingFR4Teki, global
...
/* 801A8644 001A55A4  40 80 00 74 */	bge .L_801A86B8
/* 801A8648 001A55A8  80 1F 03 20 */	lwz r0, 0x320(r31)
/* 801A864C 001A55AC  2C 00 00 16 */	cmpwi r0, 0x16
/* 801A8650 001A55B0  41 82 00 38 */	beq .L_801A8688
/* 801A8654 001A55B4  40 80 00 10 */	bge .L_801A8664
/* 801A8658 001A55B8  2C 00 00 10 */	cmpwi r0, 0x10
/* 801A865C 001A55BC  41 82 00 14 */	beq .L_801A8670
/* 801A8660 001A55C0  48 00 00 3C */	b .L_801A869C
.L_801A8664:
/* 801A8664 001A55C4  2C 00 00 18 */	cmpwi r0, 0x18
/* 801A8668 001A55C8  41 82 00 2C */	beq .L_801A8694
/* 801A866C 001A55CC  48 00 00 30 */	b .L_801A869C
.L_801A8670:
...
/* 801A8690 001A55F0  48 00 00 0C */	b .L_801A869C
.L_801A8694:
...
/* 801A86B4 001A5614  48 00 00 08 */	b .L_801A86BC
.L_801A86B8:
...
.endfn act__9TAIAdyingFR4Teki

.fn start__16TAIAdyingKabekuiFR4Teki, global
...
.endfn start__16TAIAdyingKabekuiFR4Teki

.fn act__16TAIAdyingKabekuiFR4Teki, global
...
/* 801A8758 001A56B8  40 80 00 08 */	bge .L_801A8760
...
/* 801A8768 001A56C8  40 80 00 50 */	bge .L_801A87B8
...
/* 801A8790 001A56F0  41 80 00 10 */	blt .L_801A87A0
/* 801A8794 001A56F4  80 1F 03 A8 */	lwz r0, 0x3a8(r31)
/* 801A8798 001A56F8  2C 00 00 01 */	cmpwi r0, 1
/* 801A879C 001A56FC  40 82 00 1C */	bne .L_801A87B8
.L_801A87A0:
...
/* 801A87C4 001A5724  40 80 00 74 */	bge .L_801A8838
/* 801A87C8 001A5728  80 1F 03 20 */	lwz r0, 0x320(r31)
/* 801A87CC 001A572C  2C 00 00 16 */	cmpwi r0, 0x16
/* 801A87D0 001A5730  41 82 00 38 */	beq .L_801A8808
/* 801A87D4 001A5734  40 80 00 10 */	bge .L_801A87E4
/* 801A87D8 001A5738  2C 00 00 10 */	cmpwi r0, 0x10
/* 801A87DC 001A573C  41 82 00 14 */	beq .L_801A87F0
/* 801A87E0 001A5740  48 00 00 3C */	b .L_801A881C
.L_801A87E4:
/* 801A87E4 001A5744  2C 00 00 18 */	cmpwi r0, 0x18
/* 801A87E8 001A5748  41 82 00 2C */	beq .L_801A8814
/* 801A87EC 001A574C  48 00 00 30 */	b .L_801A881C
.L_801A87F0:
...
/* 801A8810 001A5770  48 00 00 0C */	b .L_801A881C
.L_801A8814:
...
/* 801A8834 001A5794  48 00 00 08 */	b .L_801A883C
.L_801A8838:
...
.endfn act__16TAIAdyingKabekuiFR4Teki

.fn start__21TAIAdyingCrushKabekuiFR4Teki, global
...
.endfn start__21TAIAdyingCrushKabekuiFR4Teki

.fn act__10TAIAdamageFR4Teki, global
...
/* 801A88C8 001A5828  40 82 00 0C */	bne .L_801A88D4
/* 801A88CC 001A582C  38 60 00 00 */	li r3, 0
/* 801A88D0 001A5830  48 00 00 94 */	b .L_801A8964
.L_801A88D4:
...
/* 801A88F0 001A5850  41 82 00 70 */	beq .L_801A8960
...
/* 801A8910 001A5870  41 82 00 50 */	beq .L_801A8960
...
/* 801A8948 001A58A8  41 82 00 08 */	beq .L_801A8950
/* 801A894C 001A58AC  48 00 00 14 */	b .L_801A8960
.L_801A8950:
...
.endfn act__10TAIAdamageFR4Teki

.fn judgeDamage__10TAIAdamageFR4Teki, weak
/* 801A897C 001A58DC  38 60 00 01 */	li r3, 1
/* 801A8980 001A58E0  4E 80 00 20 */	blr 
.endfn judgeDamage__10TAIAdamageFR4Teki

.fn act__11TAIAinWaterFR4Teki, global
...
.endfn act__11TAIAinWaterFR4Teki

.fn actByEvent__11TAIAinWaterFR9TekiEvent, global
...
/* 801A89E8 001A5948  40 82 00 34 */	bne .L_801A8A1C
...
.endfn actByEvent__11TAIAinWaterFR9TekiEvent

.fn act__17TAIAinWaterDamageFR4Teki, global
...
/* 801A8A64 001A59C4  41 82 00 18 */	beq .L_801A8A7C
...
/* 801A8A74 001A59D4  40 82 00 08 */	bne .L_801A8A7C
/* 801A8A78 001A59D8  3B C0 00 01 */	li r30, 1
.L_801A8A7C:
/* 801A8A7C 001A59DC  57 C0 06 3F */	clrlwi. r0, r30, 0x18
/* 801A8A80 001A59E0  41 82 00 20 */	beq .L_801A8AA0
...
/* 801A8AA8 001A5A08  41 82 00 68 */	beq .L_801A8B10
/* 801A8AAC 001A5A0C  80 7D 02 8C */	lwz r3, 0x28c(r29)
/* 801A8AB0 001A5A10  28 03 00 00 */	cmplwi r3, 0
/* 801A8AB4 001A5A14  41 82 00 54 */	beq .L_801A8B08
...
/* 801A8AC4 001A5A24  41 82 00 08 */	beq .L_801A8ACC
/* 801A8AC8 001A5A28  48 00 00 20 */	b .L_801A8AE8
.L_801A8ACC:
/* 801A8ACC 001A5A2C  80 1D 04 74 */	lwz r0, 0x474(r29)
/* 801A8AD0 001A5A30  2C 00 00 05 */	cmpwi r0, 5
/* 801A8AD4 001A5A34  41 82 00 2C */	beq .L_801A8B00
...
/* 801A8AE4 001A5A44  48 00 00 1C */	b .L_801A8B00
.L_801A8AE8:
/* 801A8AE8 001A5A48  80 1D 04 74 */	lwz r0, 0x474(r29)
/* 801A8AEC 001A5A4C  2C 00 00 05 */	cmpwi r0, 5
/* 801A8AF0 001A5A50  40 82 00 10 */	bne .L_801A8B00
...
/* 801A8B04 001A5A64  48 00 00 0C */	b .L_801A8B10
.L_801A8B08:
...
.endfn act__17TAIAinWaterDamageFR4Teki

.fn actByEvent__17TAIAinWaterDamageFR9TekiEvent, global
...
/* 801A8B60 001A5AC0  40 82 00 34 */	bne .L_801A8B94
...
.endfn actByEvent__17TAIAinWaterDamageFR9TekiEvent

.fn createEffect__17TAIAinWaterDamageFR4Teki, global
...
.endfn createEffect__17TAIAinWaterDamageFR4Teki

.section .data, "wa"  # 0x80222DC0 - 0x802E9640
.balign 8
.obj lbl_802DF130, local
	.asciz "TAIAreaction.cpp"
.endobj lbl_802DF130
.balign 4
.obj lbl_802DF144, local
	.asciz "TAIAreaction"
.endobj lbl_802DF144
.balign 4
.obj lbl_802DF154, local
	.asciz "TAIAinWaterDamage"
.endobj lbl_802DF154
.balign 4
.obj lbl_802DF168, local
	.asciz "TaiAction"
.endobj lbl_802DF168
.balign 4
.obj lbl_802DF174, local
	.asciz "TAIAinWater"
.endobj lbl_802DF174
.balign 4
.obj lbl_802DF180, local
	.4byte __RTTI__9TaiAction
	.4byte 0
	.4byte 0
.endobj lbl_802DF180
.balign 4
.obj lbl_802DF18C, local
	.4byte __RTTI__9TaiAction
	.4byte 0
...
.endobj __vt__17TAIAinWaterDamage
.balign 4
.obj __vt__11TAIAinWater, global
	...
	.4byte hasNextState__9TaiActionFv
.endobj __vt__11TAIAinWater
.balign 4
.obj lbl_802DF1D8, local
	.asciz "TAIAdamage"
.endobj lbl_802DF1D8
.balign 4
.obj lbl_802DF1E4, local
	.4byte __RTTI__9TaiAction
	.4byte 0
	.4byte 0
.endobj lbl_802DF1E4
...
.endobj __vt__10TAIAdamage
.balign 4
.obj lbl_802DF210, local
	.asciz "TAIAdyingCrushKabekui"
.endobj lbl_802DF210
.balign 4
.obj lbl_802DF228, local
	.asciz "TAIAmotion"
.endobj lbl_802DF228
.balign 4
.obj lbl_802DF234, local
	.4byte __RTTI__9TaiAction
	.4byte 0
	.4byte 0
.endobj lbl_802DF234
.balign 4
.obj lbl_802DF240, local
	.asciz "TAIAdying"
.endobj lbl_802DF240
.balign 4
.obj lbl_802DF24C, local
	.4byte __RTTI__9TaiAction
	.4byte 0
...
.endobj lbl_802DF24C
.balign 4
.obj lbl_802DF260, local
	.asciz "TAIAdyingKabekui"
.endobj lbl_802DF260
.balign 4
.obj lbl_802DF274, local
	.4byte __RTTI__9TaiAction
	.4byte 0
	.4byte __RTTI__10TAIAmotion
	.4byte 0
...
.obj __vt__21TAIAdyingCrushKabekui, global
	...
	.4byte actByEvent__9TaiActionFR9TekiEvent
	.4byte hasNextState__9TaiActionFv
.endobj __vt__21TAIAdyingCrushKabekui
.balign 4
.obj __vt__16TAIAdyingKabekui, global
	...
	.4byte actByEvent__9TaiActionFR9TekiEvent
	.4byte hasNextState__9TaiActionFv
.endobj __vt__16TAIAdyingKabekui
.balign 4
.obj __vt__9TAIAdying, global
	...
	.4byte actByEvent__9TaiActionFR9TekiEvent
	.4byte hasNextState__9TaiActionFv
.endobj __vt__9TAIAdying
.balign 4
.obj lbl_802DF308, local
	.4byte __RTTI__9TaiAction
	.4byte 0
	.4byte 0
.endobj lbl_802DF308
...
.obj __vt__7TAIAdie, global
	...
	.4byte actByEvent__9TaiActionFR9TekiEvent
	.4byte hasNextState__9TaiActionFv
.endobj __vt__7TAIAdie
.balign 4
.obj lbl_802DF330, local
	.asciz "TAIAdeadCheck"
.endobj lbl_802DF330
.balign 4
.obj lbl_802DF340, local
	.4byte __RTTI__9TaiAction
	.4byte 0
	.4byte 0
.endobj lbl_802DF340
...
.obj __vt__13TAIAdeadCheck, global
	...
	.4byte actByEvent__9TaiActionFR9TekiEvent
	.4byte hasNextState__9TaiActionFv
.endobj __vt__13TAIAdeadCheck
.balign 4
.obj lbl_802DF368, local
	.asciz "TAIAhitCheckFlyingPiki"
.endobj lbl_802DF368
.balign 4
.obj lbl_802DF380, local
	.4byte __RTTI__9TaiAction
	.4byte 0
	.4byte 0
.endobj lbl_802DF380
.balign 4
.obj __vt__22TAIAhitCheckFlyingPiki, global
	...
	.4byte hasNextState__9TaiActionFv
.endobj __vt__22TAIAhitCheckFlyingPiki
...
.balign 4
.obj __RTTI__11TAIAinWater, local
	.4byte lbl_802DF174
	.4byte lbl_802DF180
.endobj __RTTI__11TAIAinWater
.balign 4
.obj __RTTI__17TAIAinWaterDamage, local
	.4byte lbl_802DF154
	.4byte lbl_802DF18C
.endobj __RTTI__17TAIAinWaterDamage
.balign 4
.obj __RTTI__10TAIAdamage, local
	.4byte lbl_802DF1D8
	.4byte lbl_802DF1E4
.endobj __RTTI__10TAIAdamage
.balign 4
...
.balign 4
.obj __RTTI__16TAIAdyingKabekui, local
	.4byte lbl_802DF260
	.4byte lbl_802DF274
.endobj __RTTI__16TAIAdyingKabekui
.balign 4
.obj __RTTI__21TAIAdyingCrushKabekui, local
	.4byte lbl_802DF210
	.4byte lbl_802DF290
.endobj __RTTI__21TAIAdyingCrushKabekui
.balign 4
.obj lbl_803E6260, local
	.asciz "TAIAdie"
.endobj lbl_803E6260
.balign 4
.obj __RTTI__7TAIAdie, local
	.4byte lbl_803E6260
	.4byte lbl_802DF308
.endobj __RTTI__7TAIAdie
.balign 4
.obj __RTTI__13TAIAdeadCheck, local
	.4byte lbl_802DF330
	.4byte lbl_802DF340
.endobj __RTTI__13TAIAdeadCheck
.balign 4
.obj __RTTI__22TAIAhitCheckFlyingPiki, local
	.4byte lbl_802DF368
	.4byte lbl_802DF380
.endobj __RTTI__22TAIAhitCheckFlyingPiki

.section .sdata2, "a"  # 0x803E8200 - 0x803EC840
.balign 8
.obj lbl_803EB788, local
	.float 0.0
.endobj lbl_803EB788
.balign 4
.obj lbl_803EB78C, local
	.float 1.0
.endobj lbl_803EB78C
.balign 4
.obj lbl_803EB790, local
	.float -2.0
.endobj lbl_803EB790
