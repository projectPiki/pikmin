...
/* 801FF038 001FBF98  4B FF FF A4 */	b .L_801FEFDC
.L_801FF03C:
/* 801FF03C 001FBF9C  28 00 00 00 */	cmplwi r0, 0
/* 801FF040 001FBFA0  40 82 00 38 */	bne .L_801FF078
...
/* 801FF120 001FC080  48 00 00 24 */	b .L_801FF144
.L_801FF124:
/* 801FF124 001FC084  7E F4 BB 78 */	mr r20, r23
/* 801FF128 001FC088  48 00 00 08 */	b .L_801FF130
.L_801FF12C:
...
/* 801FF138 001FC098  41 82 00 0C */	beq .L_801FF144
/* 801FF13C 001FC09C  28 00 00 2F */	cmplwi r0, 0x2f
/* 801FF140 001FC0A0  40 82 FF EC */	bne .L_801FF12C
.L_801FF144:
/* 801FF144 001FC0A4  88 14 00 00 */	lbz r0, 0(r20)
/* 801FF148 001FC0A8  28 00 00 00 */	cmplwi r0, 0
/* 801FF14C 001FC0AC  40 82 00 0C */	bne .L_801FF158
/* 801FF150 001FC0B0  3B C0 00 00 */	li r30, 0
/* 801FF154 001FC0B4  48 00 00 08 */	b .L_801FF15C
.L_801FF158:
...
/* 801FF168 001FC0C8  48 00 00 E0 */	b .L_801FF248
.L_801FF16C:
...
/* 801FF178 001FC0D8  40 82 00 0C */	bne .L_801FF184
/* 801FF17C 001FC0DC  38 00 00 00 */	li r0, 0
/* 801FF180 001FC0E0  48 00 00 08 */	b .L_801FF188
.L_801FF184:
/* 801FF184 001FC0E4  38 00 00 01 */	li r0, 1
.L_801FF188:
/* 801FF188 001FC0E8  2C 00 00 00 */	cmpwi r0, 0
/* 801FF18C 001FC0EC  40 82 00 0C */	bne .L_801FF198
/* 801FF190 001FC0F0  2C 1E 00 01 */	cmpwi r30, 1
/* 801FF194 001FC0F4  41 82 00 7C */	beq .L_801FF210
.L_801FF198:
...
/* 801FF1A8 001FC108  48 00 00 34 */	b .L_801FF1DC
.L_801FF1AC:
...
/* 801FF220 001FC180  40 82 00 0C */	bne .L_801FF22C
/* 801FF224 001FC184  38 00 00 00 */	li r0, 0
/* 801FF228 001FC188  48 00 00 08 */	b .L_801FF230
.L_801FF22C:
/* 801FF22C 001FC18C  38 00 00 01 */	li r0, 1
.L_801FF230:
/* 801FF230 001FC190  2C 00 00 00 */	cmpwi r0, 0
/* 801FF234 001FC194  41 82 00 0C */	beq .L_801FF240
/* 801FF238 001FC198  80 03 00 08 */	lwz r0, 8(r3)
/* 801FF23C 001FC19C  48 00 00 08 */	b .L_801FF244
.L_801FF240:
...
/* 801FF258 001FC1B8  41 80 FF 14 */	blt .L_801FF16C
/* 801FF25C 001FC1BC  38 60 FF FF */	li r3, -1
/* 801FF260 001FC1C0  48 00 00 24 */	b .L_801FF284
.L_801FF264:
/* 801FF264 001FC1C4  2C 1E 00 00 */	cmpwi r30, 0
/* 801FF268 001FC1C8  40 82 00 0C */	bne .L_801FF274
/* 801FF26C 001FC1CC  7F 43 D3 78 */	mr r3, r26
/* 801FF270 001FC1D0  48 00 00 14 */	b .L_801FF284
.L_801FF274:
...
/* 801FF280 001FC1E0  4B FF FD 5C */	b .L_801FEFDC
.L_801FF284:
...
/* 801FF2A8 001FC208  40 80 00 2C */	bge .L_801FF2D4
...
/* 801FF2BC 001FC21C  40 82 00 0C */	bne .L_801FF2C8
/* 801FF2C0 001FC220  38 00 00 00 */	li r0, 0
/* 801FF2C4 001FC224  48 00 00 08 */	b .L_801FF2CC
.L_801FF2C8:
/* 801FF2C8 001FC228  38 00 00 01 */	li r0, 1
.L_801FF2CC:
/* 801FF2CC 001FC22C  2C 00 00 00 */	cmpwi r0, 0
/* 801FF2D0 001FC230  41 82 00 0C */	beq .L_801FF2DC
.L_801FF2D4:
...
/* 801FF330 001FC290  40 80 00 30 */	bge .L_801FF360
...
/* 801FF35C 001FC2BC  48 00 00 60 */	b .L_801FF3BC
.L_801FF360:
...
/* 801FF370 001FC2D0  40 82 00 0C */	bne .L_801FF37C
/* 801FF374 001FC2D4  38 00 00 00 */	li r0, 0
/* 801FF378 001FC2D8  48 00 00 08 */	b .L_801FF380
.L_801FF37C:
/* 801FF37C 001FC2DC  38 00 00 01 */	li r0, 1
.L_801FF380:
/* 801FF380 001FC2E0  2C 00 00 00 */	cmpwi r0, 0
/* 801FF384 001FC2E4  41 82 00 0C */	beq .L_801FF390
/* 801FF388 001FC2E8  38 60 00 00 */	li r3, 0
/* 801FF38C 001FC2EC  48 00 00 30 */	b .L_801FF3BC
.L_801FF390:
...
/* 801FF420 001FC380  40 82 00 0C */	bne .L_801FF42C
/* 801FF424 001FC384  38 60 00 00 */	li r3, 0
/* 801FF428 001FC388  48 00 01 10 */	b .L_801FF538
.L_801FF42C:
...
/* 801FF450 001FC3B0  40 82 00 0C */	bne .L_801FF45C
/* 801FF454 001FC3B4  38 60 00 00 */	li r3, 0
/* 801FF458 001FC3B8  48 00 00 80 */	b .L_801FF4D8
.L_801FF45C:
...
/* 801FF480 001FC3E0  40 82 00 08 */	bne .L_801FF488
/* 801FF484 001FC3E4  48 00 00 54 */	b .L_801FF4D8
.L_801FF488:
...
/* 801FF4A4 001FC404  48 00 00 18 */	b .L_801FF4BC
.L_801FF4A8:
...
/* 801FF4C0 001FC420  41 82 00 10 */	beq .L_801FF4D0
/* 801FF4C4 001FC424  88 1C 00 00 */	lbz r0, 0(r28)
/* 801FF4C8 001FC428  28 00 00 00 */	cmplwi r0, 0
/* 801FF4CC 001FC42C  40 82 FF DC */	bne .L_801FF4A8
.L_801FF4D0:
...
/* 801FF4DC 001FC43C  40 82 00 08 */	bne .L_801FF4E4
/* 801FF4E0 001FC440  48 00 00 58 */	b .L_801FF538
.L_801FF4E4:
...
/* 801FF504 001FC464  48 00 00 18 */	b .L_801FF51C
.L_801FF508:
...
/* 801FF520 001FC480  41 82 00 10 */	beq .L_801FF530
/* 801FF524 001FC484  88 06 00 00 */	lbz r0, 0(r6)
/* 801FF528 001FC488  28 00 00 00 */	cmplwi r0, 0
/* 801FF52C 001FC48C  40 82 FF DC */	bne .L_801FF508
.L_801FF530:
...
/* 801FF590 001FC4F0  40 82 00 14 */	bne .L_801FF5A4
...
/* 801FF5A0 001FC500  48 00 00 5C */	b .L_801FF5FC
.L_801FF5A4:
...
/* 801FF644 001FC5A4  41 80 00 10 */	blt .L_801FF654
/* 801FF648 001FC5A8  80 1A 00 34 */	lwz r0, 0x34(r26)
/* 801FF64C 001FC5AC  7C 1D 00 40 */	cmplw r29, r0
/* 801FF650 001FC5B0  41 80 00 1C */	blt .L_801FF66C
.L_801FF654:
...
/* 801FF670 001FC5D0  41 80 00 14 */	blt .L_801FF684
...
/* 801FF680 001FC5E0  41 80 00 1C */	blt .L_801FF69C
.L_801FF684:
...
/* 801FF6F0 001FC650  41 82 00 0C */	beq .L_801FF6FC
...
/* 801FF730 001FC690  41 80 00 10 */	blt .L_801FF740
/* 801FF734 001FC694  80 1F 00 34 */	lwz r0, 0x34(r31)
/* 801FF738 001FC698  7C 1D 00 40 */	cmplw r29, r0
/* 801FF73C 001FC69C  41 80 00 1C */	blt .L_801FF758
.L_801FF740:
...
/* 801FF75C 001FC6BC  41 80 00 14 */	blt .L_801FF770
...
/* 801FF76C 001FC6CC  41 80 00 1C */	blt .L_801FF788
.L_801FF770:
...
/* 801FF7B0 001FC710  40 82 00 0C */	bne .L_801FF7BC
/* 801FF7B4 001FC714  38 60 FF FF */	li r3, -1
/* 801FF7B8 001FC718  48 00 00 58 */	b .L_801FF810
.L_801FF7BC:
...
/* 801FF87C 001FC7DC  41 82 00 20 */	beq .L_801FF89C
...
/* 801FF8A0 001FC800  40 82 00 0C */	bne .L_801FF8AC
...
/* 801FF8B0 001FC810  41 82 00 1C */	beq .L_801FF8CC
...
/* 801FF8D4 001FC834  40 80 00 10 */	bge .L_801FF8E4
/* 801FF8D8 001FC838  7C 1D E2 14 */	add r0, r29, r28
/* 801FF8DC 001FC83C  7C 00 18 40 */	cmplw r0, r3
/* 801FF8E0 001FC840  40 81 00 20 */	ble .L_801FF900
.L_801FF8E4:
...
/* 801FF948 001FC8A8  41 82 00 0C */	beq .L_801FF954
