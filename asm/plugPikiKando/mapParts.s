...
/* 801187E8 00115748  40 82 00 0C */	bne .L_801187F4
/* 801187EC 0011574C  C3 FE 01 68 */	lfs f31, 0x168(r30)
/* 801187F0 00115750  48 00 00 08 */	b .L_801187F8
.L_801187F4:
...
/* 80118800 00115760  41 82 02 A4 */	beq .L_80118AA4
...
/* 8011889C 001157FC  40 82 00 0C */	bne .L_801188A8
/* 801188A0 00115800  80 9E 01 40 */	lwz r4, 0x140(r30)
/* 801188A4 00115804  48 00 00 0C */	b .L_801188B0
.L_801188A8:
...
/* 8011890C 0011586C  41 82 00 10 */	beq .L_8011891C
...
/* 80118960 001158C0  41 82 00 3C */	beq .L_8011899C
/* 80118964 001158C4  40 80 00 10 */	bge .L_80118974
/* 80118968 001158C8  2C 00 00 00 */	cmpwi r0, 0
/* 8011896C 001158CC  40 80 00 14 */	bge .L_80118980
/* 80118970 001158D0  48 00 01 70 */	b .L_80118AE0
.L_80118974:
/* 80118974 001158D4  2C 00 00 04 */	cmpwi r0, 4
/* 80118978 001158D8  40 80 01 68 */	bge .L_80118AE0
/* 8011897C 001158DC  48 00 00 F4 */	b .L_80118A70
.L_80118980:
/* 80118980 001158E0  C0 02 9F BC */	lfs f0, lbl_803EA1BC@sda21(r2)
/* 80118984 001158E4  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80118988 001158E8  40 80 01 58 */	bge .L_80118AE0
...
/* 80118998 001158F8  48 00 01 48 */	b .L_80118AE0
.L_8011899C:
...
/* 801189D0 00115930  41 82 00 10 */	beq .L_801189E0
/* 801189D4 00115934  80 1E 01 7C */	lwz r0, 0x17c(r30)
/* 801189D8 00115938  2C 00 00 01 */	cmpwi r0, 1
/* 801189DC 0011593C  40 82 00 60 */	bne .L_80118A3C
.L_801189E0:
...
/* 801189EC 0011594C  40 80 00 34 */	bge .L_80118A20
/* 801189F0 00115950  57 E0 06 3F */	clrlwi. r0, r31, 0x18
/* 801189F4 00115954  41 82 00 2C */	beq .L_80118A20
/* 801189F8 00115958  80 1E 01 7C */	lwz r0, 0x17c(r30)
/* 801189FC 0011595C  2C 00 00 01 */	cmpwi r0, 1
/* 80118A00 00115960  40 82 00 0C */	bne .L_80118A0C
/* 80118A04 00115964  38 00 00 00 */	li r0, 0
/* 80118A08 00115968  48 00 00 08 */	b .L_80118A10
.L_80118A0C:
...
/* 80118A48 001159A8  40 80 00 98 */	bge .L_80118AE0
/* 80118A4C 001159AC  2C 00 00 01 */	cmpwi r0, 1
/* 80118A50 001159B0  40 82 00 0C */	bne .L_80118A5C
/* 80118A54 001159B4  38 00 00 00 */	li r0, 0
/* 80118A58 001159B8  48 00 00 08 */	b .L_80118A60
.L_80118A5C:
...
/* 80118A6C 001159CC  48 00 00 74 */	b .L_80118AE0
.L_80118A70:
...
/* 80118A90 001159F0  40 82 00 50 */	bne .L_80118AE0
...
/* 80118AA0 00115A00  48 00 00 40 */	b .L_80118AE0
.L_80118AA4:
...
/* 80118C1C 00115B7C  40 80 00 08 */	bge .L_80118C24
