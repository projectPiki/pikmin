...
/* 800BAFE4 000B7F44  41 82 00 34 */	beq .L_800BB018
/* 800BAFE8 000B7F48  80 7E 00 1C */	lwz r3, 0x1c(r30)
/* 800BAFEC 000B7F4C  28 03 00 00 */	cmplwi r3, 0
/* 800BAFF0 000B7F50  41 82 00 14 */	beq .L_800BB004
/* 800BAFF4 000B7F54  41 82 00 10 */	beq .L_800BB004
...
/* 800BB010 000B7F70  41 82 00 08 */	beq .L_800BB018
...
/* 800BB098 000B7FF8  41 82 00 14 */	beq .L_800BB0AC
/* 800BB09C 000B7FFC  41 82 00 10 */	beq .L_800BB0AC
...
/* 800BB0B8 000B8018  41 82 00 08 */	beq .L_800BB0C0
...
/* 800BB120 000B8080  41 82 00 10 */	beq .L_800BB130
...
/* 800BB17C 000B80DC  41 82 00 20 */	beq .L_800BB19C
...
/* 800BB198 000B80F8  40 82 00 0C */	bne .L_800BB1A4
.L_800BB19C:
/* 800BB19C 000B80FC  38 60 00 01 */	li r3, 1
/* 800BB1A0 000B8100  48 00 02 EC */	b .L_800BB48C
.L_800BB1A4:
...
/* 800BB1E8 000B8148  40 82 00 64 */	bne .L_800BB24C
...
/* 800BB258 000B81B8  40 80 00 0C */	bge .L_800BB264
/* 800BB25C 000B81BC  38 60 00 01 */	li r3, 1
/* 800BB260 000B81C0  48 00 02 2C */	b .L_800BB48C
.L_800BB264:
...
/* 800BB2AC 000B820C  41 82 00 10 */	beq .L_800BB2BC
...
/* 800BB348 000B82A8  40 81 00 5C */	ble .L_800BB3A4
...
/* 800BB3AC 000B830C  40 81 00 34 */	ble .L_800BB3E0
...
/* 800BB3DC 000B833C  48 00 00 68 */	b .L_800BB444
.L_800BB3E0:
...
/* 800BB4D8 000B8438  41 82 00 2C */	beq .L_800BB504
...
/* 800BB4F8 000B8458  40 81 00 0C */	ble .L_800BB504
...
.balign 8
.obj lbl_803E04B8, local
	.float 0.0
.endobj lbl_803E04B8
.obj lbl_803E04BC, local
	.float 0.0
.endobj lbl_803E04BC
.obj lbl_803E04C0, local
	.float 0.0
.endobj lbl_803E04C0
.obj lbl_803E04C4, local
	.float 0.0
.endobj lbl_803E04C4
.balign 4
.obj lbl_803E04C8, local
	.asciz "ActGoto"
.endobj lbl_803E04C8
.balign 4
...
.obj __RTTI__7ActGoto, local
	.4byte lbl_803E04C8
	.4byte lbl_802B6BA0
.endobj __RTTI__7ActGoto
.obj __RTTI__Q26Action11Initialiser, local
	.4byte lbl_802B6C30
	.4byte 0
.endobj __RTTI__Q26Action11Initialiser
.obj __RTTI__Q27ActGoto11Initialiser, local
	.4byte lbl_802B6C18
	.4byte lbl_802B6C44
.endobj __RTTI__Q27ActGoto11Initialiser

.section .sdata2, "a"  # 0x803E8200 - 0x803EC840
.balign 8
.obj lbl_803E9528, local
	.float 1.0
.endobj lbl_803E9528
.obj lbl_803E952C, local
	.float 32767.0
.endobj lbl_803E952C
.obj lbl_803E9530, local
	.float 4.0
.endobj lbl_803E9530
.obj lbl_803E9534, local
	.float 2.0
.endobj lbl_803E9534
.balign 8
.obj lbl_803E9538, local
	.8byte 0x4330000080000000
.endobj lbl_803E9538
.obj lbl_803E9540, local
	.float 20.0
.endobj lbl_803E9540
.obj lbl_803E9544, local
	.float 0.0
.endobj lbl_803E9544
.balign 8
.obj lbl_803E9548, local
	.double 0.5
.endobj lbl_803E9548
.balign 8
.obj lbl_803E9550, local
	.double 3.0
.endobj lbl_803E9550
.obj lbl_803E9558, local
	.float 3.1415927
.endobj lbl_803E9558
.obj lbl_803E955C, local
	.float 9.0
.endobj lbl_803E955C
