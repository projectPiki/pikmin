...
/* 80117224 00114184  41 82 00 08 */	beq .L_8011722C
...
/* 801172CC 0011422C  41 82 00 0C */	beq .L_801172D8
...
/* 8011736C 001142CC  41 82 00 10 */	beq .L_8011737C
...
/* 801173F0 00114350  40 82 00 20 */	bne .L_80117410
...
/* 8011740C 0011436C  48 00 00 18 */	b .L_80117424
.L_80117410:
...
/* 80117484 001143E4  48 00 00 70 */	b .L_801174F4
.L_80117488:
/* 80117488 001143E8  2C 1E FF FF */	cmpwi r30, -1
/* 8011748C 001143EC  40 82 00 20 */	bne .L_801174AC
...
/* 801174A8 00114408  48 00 00 1C */	b .L_801174C4
.L_801174AC:
...
/* 80117510 00114470  41 82 00 0C */	beq .L_8011751C
/* 80117514 00114474  38 00 00 01 */	li r0, 1
/* 80117518 00114478  48 00 00 30 */	b .L_80117548
.L_8011751C:
...
/* 80117538 00114498  40 82 00 0C */	bne .L_80117544
/* 8011753C 0011449C  38 00 00 01 */	li r0, 1
/* 80117540 001144A0  48 00 00 08 */	b .L_80117548
.L_80117544:
/* 80117544 001144A4  38 00 00 00 */	li r0, 0
.L_80117548:
/* 80117548 001144A8  54 00 06 3F */	clrlwi. r0, r0, 0x18
/* 8011754C 001144AC  41 82 FF 3C */	beq .L_80117488
...
/* 801175A0 00114500  48 00 00 64 */	b .L_80117604
.L_801175A4:
/* 801175A4 00114504  2C 1E FF FF */	cmpwi r30, -1
/* 801175A8 00114508  40 82 00 20 */	bne .L_801175C8
...
/* 801175C4 00114524  48 00 00 1C */	b .L_801175E0
.L_801175C8:
...
/* 80117620 00114580  41 82 00 0C */	beq .L_8011762C
/* 80117624 00114584  38 00 00 01 */	li r0, 1
/* 80117628 00114588  48 00 00 30 */	b .L_80117658
.L_8011762C:
...
/* 80117648 001145A8  40 82 00 0C */	bne .L_80117654
/* 8011764C 001145AC  38 00 00 01 */	li r0, 1
/* 80117650 001145B0  48 00 00 08 */	b .L_80117658
.L_80117654:
/* 80117654 001145B4  38 00 00 00 */	li r0, 0
.L_80117658:
/* 80117658 001145B8  54 00 06 3F */	clrlwi. r0, r0, 0x18
/* 8011765C 001145BC  41 82 FF 48 */	beq .L_801175A4
...
/* 801176B0 00114610  48 00 00 70 */	b .L_80117720
.L_801176B4:
/* 801176B4 00114614  2C 1E FF FF */	cmpwi r30, -1
/* 801176B8 00114618  40 82 00 20 */	bne .L_801176D8
...
/* 801176D4 00114634  48 00 00 1C */	b .L_801176F0
.L_801176D8:
...
/* 8011773C 0011469C  41 82 00 0C */	beq .L_80117748
/* 80117740 001146A0  38 00 00 01 */	li r0, 1
/* 80117744 001146A4  48 00 00 30 */	b .L_80117774
.L_80117748:
...
/* 80117764 001146C4  40 82 00 0C */	bne .L_80117770
/* 80117768 001146C8  38 00 00 01 */	li r0, 1
/* 8011776C 001146CC  48 00 00 08 */	b .L_80117774
.L_80117770:
/* 80117770 001146D0  38 00 00 00 */	li r0, 0
.L_80117774:
/* 80117774 001146D4  54 00 06 3F */	clrlwi. r0, r0, 0x18
/* 80117778 001146D8  41 82 FF 3C */	beq .L_801176B4
...
/* 801177DC 0011473C  41 82 00 58 */	beq .L_80117834
...
/* 801177F4 00114754  41 82 00 30 */	beq .L_80117824
...
/* 8011780C 0011476C  41 82 00 18 */	beq .L_80117824
...
/* 80117828 00114788  40 81 00 0C */	ble .L_80117834
