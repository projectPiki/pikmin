    ...
    : YaiStrategy(TAImarStateID::COUNT, TAImarStateID::Unk2)
{
	...
	TAIAdyingMar* dying1                     = new TAIAdyingMar(TAI_NO_TRANSIT, TAImarMotionID::Unk0);
	TAIAdyingMar* dying2                     = new TAIAdyingMar(TAI_NO_TRANSIT, TAImarMotionID::Unk12);
	...
	TAIAreserveMotion* motion1               = new TAIAreserveMotion(TAI_NO_TRANSIT, TAImarMotionID::Unk6);
	TAIAflickCheckTimerMar* flickCheckTimer  = new TAIAflickCheckTimerMar(TAImarStateID::Unk4);
	TAIAflickingMar* flicking1               = new TAIAflickingMar(TAImarStateID::Unk3, TAImarMotionID::Unk1);
	TAIAstickingPikiMarFly* stickingPikiFly  = new TAIAstickingPikiMarFly(TAImarStateID::Unk5);
	TAIAdescent* descent                     = new TAIAdescent(TAImarStateID::Unk6, TAImarMotionID::Unk11);
	TAIAlandingMar* landing                  = new TAIAlandingMar(TAImarStateID::Unk7, TAImarMotionID::Unk7);
	TAIAreserveMotion* motion2               = new TAIAreserveMotion(TAI_NO_TRANSIT, TAImarMotionID::Unk2);
	TAIAflickCheckMar* flickCheckMar         = new TAIAflickCheckMar(TAImarStateID::Unk8);
	TAIAflickingMar* flicking2               = new TAIAflickingMar(TAImarStateID::Unk9, TAImarMotionID::Unk9);
	...
	TAIAtakeOffMar* takeOff                  = new TAIAtakeOffMar(TAImarStateID::Unk3, TAImarMotionID::Unk10);
	...
	TAIAfireBreathMar* fireBreath            = new TAIAfireBreathMar(TAImarStateID::Unk3, TAImarMotionID::Unk8, new BreathEffect());
	...
	TAIAflyingDistanceInTerritoryMar* flyingDistanceInTerritory
	    = new TAIAflyingDistanceInTerritoryMar(TAImarStateID::Unk3, TAImarMotionID::Unk6, 27.0f * PI / 180.0f, 0.15f);
