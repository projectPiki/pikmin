...
NaviProp::NaviProp()
{
	...
	mCreatureProps.mFaceDirAdjust.mValue = 0.5f;
	mCreatureProps.mAcceleration.mValue  = 0.2f;
}
...
f32 Navi::getiMass()
{
	...
	return static_cast<NaviProp*>(mProps)->mNaviProps._21C();
}
 ...
 * Size:	000044
 */
void NaviProp::read(RandomAccessStream& input)
{
