...
MAP_PATH = "build/pikmin.usa.1/build.map"
...
# Progress flavor
codeFrac = 30           # total code "item" amount
dataFrac = 100          # total data "item" amount
codeItem = "ship parts" # code flavor item
dataItem = "Pikmin"     # data flavor item
