#ifndef _TAIMIZINKOSTRATEGY_H
#define _TAIMIZINKOSTRATEGY_H

/**
 * .obj __vt__18TaiMizinkoStrategy, global
 ...
 * @brief TODO
 */
struct TaiMizinkoStrategy : public TaiStrategy, public TekiStrategy {
	virtual void start(Teki&);           // _08
	virtual void draw(Teki&, Graphics&); // _18
};
