#ifndef _TAIMIURINPARAMETERS_H
#define _TAIMIURINPARAMETERS_H

/**
 * .obj __vt__19TAImiurinParameters, weak
 ...
 * @brief TODO
 */
struct TAImiurinParameters : public ANode, public TekiParameters, public Node {
};
