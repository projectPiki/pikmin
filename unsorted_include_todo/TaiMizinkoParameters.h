#ifndef _TAIMIZINKOPARAMETERS_H
#define _TAIMIZINKOPARAMETERS_H

/**
 * .obj __vt__20TaiMizinkoParameters, weak
 ...
 * @brief TODO
 */
struct TaiMizinkoParameters : public ANode, public TekiParameters, public Node {
};
