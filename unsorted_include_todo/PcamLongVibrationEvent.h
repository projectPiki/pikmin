#ifndef _PCAMLONGVIBRATIONEVENT_H
#define _PCAMLONGVIBRATIONEVENT_H
 ...
 * @brief TODO
 */
struct PcamLongVibrationEvent : public NNode, public PeveSerialEvent, public PeveEvent {
