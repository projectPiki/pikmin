#ifndef _TAISHELLPARAMETERS_H
#define _TAISHELLPARAMETERS_H

/**
 * .obj __vt__18TaiShellParameters, weak
 ...
 * @brief TODO
 */
struct TaiShellParameters : public ANode, public TekiParameters, public Node {
};
