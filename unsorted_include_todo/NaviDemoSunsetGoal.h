#ifndef _NAVIDEMOSUNSETGOAL_H
#define _NAVIDEMOSUNSETGOAL_H
 ...
 * @brief TODO
 */
struct NaviDemoSunsetGoal : public RefCountable, public Creature, public ItemCreature, public ItemObject, public AICreature { };
