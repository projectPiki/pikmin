#ifndef _TAIKABEKUIASTRATEGY_H
#define _TAIKABEKUIASTRATEGY_H

/**
 * .obj __vt__19TAIkabekuiAStrategy, weak
 ...
 * @brief TODO
 */
struct TAIkabekuiAStrategy : public YaiStrategy, public TekiStrategy {
