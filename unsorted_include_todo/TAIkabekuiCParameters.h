#ifndef _TAIKABEKUICPARAMETERS_H
#define _TAIKABEKUICPARAMETERS_H

/**
 * .obj __vt__21TAIkabekuiCParameters, weak
 ...
 * @brief TODO
 */
struct TAIkabekuiCParameters : public ANode, public TekiParameters, public Node {
