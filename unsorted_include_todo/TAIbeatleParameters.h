#ifndef _TAIBEATLEPARAMETERS_H
#define _TAIBEATLEPARAMETERS_H

/**
 * .obj __vt__19TAIbeatleParameters, weak
 ...
 * @brief TODO
 */
struct TAIbeatleParameters : public ANode, public TekiParameters, public Node {
};
