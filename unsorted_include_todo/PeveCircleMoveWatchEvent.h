#ifndef _PEVECIRCLEMOVEWATCHEVENT_H
#define _PEVECIRCLEMOVEWATCHEVENT_H
 ...
 * @brief TODO
 */
struct PeveCircleMoveWatchEvent : public NNode, public PeveParallelEvent, public PeveEvent {
