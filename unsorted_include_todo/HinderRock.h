#ifndef _HINDERROCK_H
#define _HINDERROCK_H
 ...
 * @brief TODO
 */
struct HinderRock : public RefCountable, public Creature, public ItemCreature, public WorkObject, public AICreature {
	virtual void insideSafeArea(Vector3f&);   // _10
	virtual void startAI(int);                // _34
	virtual void doSave(RandomAccessStream&); // _50
	virtual void doLoad(RandomAccessStream&); // _54
	...
	virtual void update();                    // _E0
	virtual void refresh(Graphics&);          // _EC
	virtual void isHinderRock();              // _160
	virtual void isFinished();                // _164
	virtual void workable(Vector3f&);         // _168
