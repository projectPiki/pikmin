#ifndef _TAIKABEKUICSTRATEGY_H
#define _TAIKABEKUICSTRATEGY_H

/**
 * .obj __vt__19TAIkabekuiCStrategy, weak
 ...
 * @brief TODO
 */
struct TAIkabekuiCStrategy : public YaiStrategy, public TekiStrategy {
};
