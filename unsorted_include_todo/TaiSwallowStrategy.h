#ifndef _TAISWALLOWSTRATEGY_H
#define _TAISWALLOWSTRATEGY_H

/**
 * .obj __vt__18TaiSwallowStrategy, global
 ...
 * @brief TODO
 */
struct TaiSwallowStrategy : public TaiStrategy, public TekiStrategy {
	virtual void start(Teki&);                         // _08
	virtual void draw(Teki&, Graphics&);               // _18
	virtual void drawDebugInfo(Teki&, Graphics&);      // _1C
	virtual void interact(Teki&, TekiInteractionKey&); // _20
