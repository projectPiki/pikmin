...
struct AState<Navi> {
	...
	virtual void init(Navi *);          // _38 (weak)
	virtual void exec(Navi *);          // _3C (weak)
	virtual void cleanup(Navi *);       // _40 (weak)
 ...
 * @brief TODO
 */
struct NaviState : public Receiver<Navi>, public AState<Navi> {
