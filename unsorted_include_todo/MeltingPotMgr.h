#ifndef _MELTINGPOTMGR_H
#define _MELTINGPOTMGR_H

/**
 * .obj __vt__13MeltingPotMgr, weak
...
struct CreatureNodeMgr {
	...
	virtual ~CreatureNodeMgr();    // _48 (weak)
 ...
 * @brief TODO
 */
struct MeltingPotMgr : public CreatureNodeMgr, public ANode, public CoreNode, public Node, public ObjectMgr {
