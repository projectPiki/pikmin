#ifndef _TAIMIZIGENSTRATEGY_H
#define _TAIMIZIGENSTRATEGY_H

/**
 * .obj __vt__18TaiMizigenStrategy, global
 ...
 * @brief TODO
 */
struct TaiMizigenStrategy : public TaiStrategy, public TekiStrategy {
	virtual void start(Teki &);  // _08
