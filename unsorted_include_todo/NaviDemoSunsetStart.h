#ifndef _NAVIDEMOSUNSETSTART_H
#define _NAVIDEMOSUNSETSTART_H
 ...
 * @brief TODO
 */
struct NaviDemoSunsetStart : public RefCountable, public Creature, public ItemCreature, public ItemObject, public AICreature { };
