#ifndef _TAISWALLOWPARAMETERS_H
#define _TAISWALLOWPARAMETERS_H

/**
 * .obj __vt__20TaiSwallowParameters, weak
 ...
 * @brief TODO
 */
struct TaiSwallowParameters : public ANode, public TekiParameters, public Node {
