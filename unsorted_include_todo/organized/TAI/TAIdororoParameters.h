#ifndef _TAIDOROROPARAMETERS_H
#define _TAIDOROROPARAMETERS_H

/**
 * .obj __vt__19TAIdororoParameters, weak
 ...
 * @brief TODO
 */
struct TAIdororoParameters : public ANode, public TekiParameters, public Node {
