#ifndef _TAIROCPEARLPARAMETERS_H
#define _TAIROCPEARLPARAMETERS_H

/**
 * .obj __vt__21TaiRocpearlParameters, weak
 ...
 * @brief TODO
 */
struct TaiRocpearlParameters : public ANode, public TekiParameters, public Node {
