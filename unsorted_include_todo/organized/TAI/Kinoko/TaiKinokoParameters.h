#ifndef _TAIKINOKOPARAMETERS_H
#define _TAIKINOKOPARAMETERS_H

/**
 * .obj __vt__19TaiKinokoParameters, weak
 ...
 * @brief TODO
 */
struct TaiKinokoParameters : public ANode, public TekiParameters, public Node {
