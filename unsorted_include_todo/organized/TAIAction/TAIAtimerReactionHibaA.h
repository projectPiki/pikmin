#ifndef _TAIATIMERREACTIONHIBAA_H
#define _TAIATIMERREACTIONHIBAA_H

/**
 * .obj __vt__22TAIAtimerReactionHibaA, weak
 ...
 * @brief TODO
 */
struct TAIAtimerReactionHibaA : public TAIAtimerReaction, public TaiAction {
