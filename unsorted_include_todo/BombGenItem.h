#ifndef _BOMBGENITEM_H
#define _BOMBGENITEM_H
 ...
 * @brief TODO
 */
struct BombGenItem : public RefCountable, public Creature, public ItemCreature, public ItemObject, public AICreature {
	virtual void isVisible();          // _74
	virtual void isAtari();            // _84
	virtual void isAlive();            // _88
	virtual void needFlick(Creature*); // _94
