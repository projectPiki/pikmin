#ifndef _NAVIDEMOSUNSETSTATE_DEMOSTATE_H
#define _NAVIDEMOSUNSETSTATE_DEMOSTATE_H
...
struct Receiver<NaviDemoSunsetState> {
	...
	virtual void procAnimMsg(NaviDemoSunsetState*, MsgAnim*);       // _20 (weak)
...
struct AState<NaviDemoSunsetState> {
	...
	virtual void init(NaviDemoSunsetState*);         // _38 (weak)
	virtual void exec(NaviDemoSunsetState*);         // _3C (weak)
	virtual void cleanup(NaviDemoSunsetState*);      // _40 (weak)
 ...
 * @brief TODO
 */
struct DemoState : public Receiver<NaviDemoSunsetState>, public AState<NaviDemoSunsetState> {
};
} // namespace NaviDemoSunsetState
