#ifndef _NAVIDEMOSUNSETSTATE_WAITSTATE_H
#define _NAVIDEMOSUNSETSTATE_WAITSTATE_H
 ...
 * @brief TODO
 */
struct WaitState : public Receiver<NaviDemoSunsetState>, public AState<NaviDemoSunsetState> {
	virtual void init(NaviDemoSunsetState *);     // _38
	virtual void exec(NaviDemoSunsetState *);     // _3C
	virtual void cleanup(NaviDemoSunsetState *);  // _40
