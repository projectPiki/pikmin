#ifndef _NAVIDEMOSUNSETSTATE_SITSTATE_H
#define _NAVIDEMOSUNSETSTATE_SITSTATE_H
 ...
 * @brief TODO
 */
struct SitState : public Receiver<NaviDemoSunsetState>, public AState<NaviDemoSunsetState> {
	virtual void init(NaviDemoSunsetState*);    // _38
	virtual void exec(NaviDemoSunsetState*);    // _3C
	virtual void cleanup(NaviDemoSunsetState*); // _40
};
