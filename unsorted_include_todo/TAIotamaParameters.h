#ifndef _TAIOTAMAPARAMETERS_H
#define _TAIOTAMAPARAMETERS_H

/**
 * .obj __vt__18TAIotamaParameters, weak
 ...
 * @brief TODO
 */
struct TAIotamaParameters : public ANode, public TekiParameters, public Node {
};
