#ifndef _TAIBLACKSWALLOWPARAMETERS_H
#define _TAIBLACKSWALLOWPARAMETERS_H

/**
 * .obj __vt__25TaiBlackSwallowParameters, weak
 ...
 * @brief TODO
 */
struct TaiBlackSwallowParameters : public ANode, public TekiParameters, public Node {
};
