#ifndef _TAIMIURINSTRATEGY_H
#define _TAIMIURINSTRATEGY_H

/**
 * .obj __vt__17TAImiurinStrategy, global
 ...
 * @brief TODO
 */
struct TAImiurinStrategy : public YaiStrategy, public TekiStrategy {
	virtual void interact(Teki&, TekiInteractionKey&); // _20
};
