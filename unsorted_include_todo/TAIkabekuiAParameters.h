#ifndef _TAIKABEKUIAPARAMETERS_H
#define _TAIKABEKUIAPARAMETERS_H

/**
 * .obj __vt__21TAIkabekuiAParameters, weak
 ...
 * @brief TODO
 */
struct TAIkabekuiAParameters : public ANode, public TekiParameters, public Node {
